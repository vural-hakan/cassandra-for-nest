...
let DeviceController = class DeviceController {
    ...
    async doSomething() {
        ...
        (0, console_1.assert)((await this.deviceService.findAll()).length === 1, 'assert Map Delete');
        await this.deviceService.deleteBySerialNumber(device2.serialNumber);
        (0, console_1.assert)((await this.deviceService.findAll()).length === 0, 'assert Map Delete');
